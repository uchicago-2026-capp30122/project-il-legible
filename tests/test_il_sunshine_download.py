from pull_IL_sunshine.Illinois_Sunshine_donations_pull import match_sponsor_to_candidate, get_committee_ids, download_donations
...
def test_get_committee_ids():
    ...
    assert sorted(get_committee_ids([16940, 40755, 16939])) == ['16283', '34378', '34379']

...
def index():
    ...
    charts = {
        ...
        "sankey": viz.bill_progress_sankey(bill_query).to_html(full_html=False, include_plotlyjs='cdn'),
        "passing_by_entities": viz.bill_passage_pct_entity_donations_scatter(sponsor_query).to_json(),
    }

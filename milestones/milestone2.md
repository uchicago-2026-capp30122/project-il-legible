...
2) Make a database framework
2) Data exploration to ID key variables: currently interested in exploring sponsorships (linked to donations), timing between bill introductions and readings, and distribution of votes

Step 2: Finalize database (by Feb 11th)
4) Collect the data: Open States and Illinois Sunshine
5) Clean and merge the data into a database
